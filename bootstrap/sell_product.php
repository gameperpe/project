...
$sql = "SELECT * FROM qrcode WHERE admin ='{$_SESSION["User"]}' ";
...
<div class="card-header border-danger bg-danger">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">แจ้งเตือนชำระเงินแล้ว</th>
      <th scope="col">ที่อยู่</th>
      <th scope="col">ส่งสำเร็จแล้ว</th>
...
?>
  <tbody>
    <tr>
      ...
      <td><p class="mt-4"><?php echo $row['delivery_style'];?></p></td>
      <td>
      <p class="mt-4"><?php echo $row['user'];?></p>
      </td>
      <td>
      <p class="mt-4">ชำระเงินแล้ว</p>
      </td>
      <td>
      <p class="mt-4"><?php echo $row['address'];?></p>
      </td>
      <td>
      <a href="delete_qrcode.php?id=<?php echo $row['id'];?>"><button class="btn btn-primary mt-3" type="button" name ="insert_basket" id="insert_basket">ส่งสำเร็จแล้ว</button></a>
      </td>
