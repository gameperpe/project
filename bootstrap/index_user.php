...
<!-- ส่วน header มี ในส่วของ logo ทั้งหมด -->
  ...
  <div class="d-flex justify-content-center" >
    ...
    <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
          <a href="children_toys.php"><img src="category_img/telephone.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
   
    <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
          <a href="phone.php"><img src="category_img/pid.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
    ...
    <div class="p-2 bd-highlight"> 
     ...
     <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
          <a href="electrical_appliances.php"><img src="category_img/play.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
       ...
       <div class="img-resize ">
        ...
        <div class="card-footer bg-transparent border-secondary d-flex justify-content-center">
          <div class="d-grid gap-2 d-md-block  ">
            ...
            <a href="show_product_admin_form.php?id=<?php echo $row['id'];?>"><button class="btn btn-outline-primary" type="button" name ="insert_basket" id="insert_basket">เพิ่มลงตะกร้า</button></a>
          </div>
        </div>
        </div>
        </div>
