...
$sql = "SELECT * FROM qrcode WHERE user ='{$_SESSION["User"]}' ";
...
<div class="card-header border-danger bg-danger">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">ระยะเวลาการจัดส่ง</th>
      <th scope="col">รับสินค้าแล้ว</th>
      <th scope="col">แจ้งคืนสินค้า</th>
...
?>
  <tbody>
    <tr>
      ...
      <td><p class="mt-4">ปกติ</p></td>
      <td>
      <p class="mt-4">2-3วันจากการซื้อสินค้า</p>
      </td>
      <td>
      <a href="return_product.php?id=<?php echo $row['id'];?>"><button class="btn btn-success mt-3" type="button">แจ้งได้รับสินค้าแล้ว</button></a>
      </td>

      <td><a href="https://www.facebook.com/UTKK-SHOP-%E0%B9%80%E0%B8%94%E0%B9%82%E0%B8%A1-101968211969088?_rdc=1&_rdr" target="_blank"><button class="btn btn-danger mt-3" type="button">แจ้งคืนสินค้า</button></a></td>
