...
include('connect.php');
session_start();
$sql = "SELECT * FROM goods WHERE category = 'electrical_appliances'";
...
?>
   <div class="d-flex bd-highlight">
        <div class="p-2  bd-highlight item_header "><a href="index_user.php"><img src="img/logo.png" style="width: 250px;" alt="..."></a></div>
    ...
    <div class="d-flex align-items-center justify-content-center" style="width: 600px; background-color: rgb(247, 90, 90);">
      ...
      <div class="p-2 bd-highlight">
        <div class="img-resize-category ">
          <a href="shoes_user.php"> <img src="category_img/long.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
        </div>
    </div>
    <div class="p-2 bd-highlight">
      <div class="img-resize-category ">
        <a href="clothing_user.php"> <img src="category_img/sh.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
    <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
        <a href="phone_user.php"><img src="category_img/telephone.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
   
    <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
        <a href="electrical_appliances_user.php"><img src="category_img/pid.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
    
    <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
        <a href="computer_user.php"><img src="category_img/com.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>

     <div class="p-2 bd-highlight"> 
      <div class="img-resize-category ">
        <a href="echildren_toys_user.php"><img src="category_img/play.png" class="card-img-top" style="width: 5rem; height: 5rem;" alt="..."></a>
      </div>
    </div>
         ...
         <div class="img-resize ">
          ...
          <div class="card-footer bg-transparent border-secondary d-flex justify-content-center">
            <div class="d-grid gap-2 d-md-block  ">
              <a href="show_product_admin_form.php?id=<?php echo $row['id'];?>"><button class="btn btn-outline-primary" type="button">ดูรายละเอียดสินค้า</button></a>
              <a href="insert_basket.php?id=<?php echo $row['id'];?>"><button class="btn btn-outline-primary" type="button" name ="insert_basket" id="insert_basket">เพิ่มลงตะกร้า</button></a>
            </div>
          </div>
          </div>
          </div>
