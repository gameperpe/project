...
<div class="d-flex p-2 bd-highlight card_main">
  <div class="d-flex  justify-content-start align-items-center col-3 card_img"><img src="img/profile.jpg" style="width: 180px; border-radius: 50%;" alt="..."></div>
  <div class="d-flex  flex-lg-column justify-content-center  card_body  ">สวัสดีคุณ <?php print_r( $_SESSION["User1"]);?>
...
?>
        <form action="update_seller.php?id=<?php echo $row['id'];?>" method="POST" enctype="multipart/form-data">
          <div class="mb-3">
          ...
          <div class="mb-3 ">
            <div class="form-floating">
              <textarea  placeholder="<?php echo $row["detail"]?>" id="detail" name="detail"  ></textarea>
           </div>
          </div>
          ...
          <button type="submit" id="submit" name= "submit" class="btn btn-primary">ยืนยันการแก้ไขรายการสินค้า</button>
        </form>
       ...
       <div class="img-resize ">
        ...
        <div class="card-footer bg-transparent border-secondary d-flex justify-content-center">
          <div class="d-grid gap-2 d-md-block  ">
            <button class="btn btn-warning " type="button">แก้ไขรายละเอียด</button>
